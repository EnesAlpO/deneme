...
/*1.Yöntem
if(!isset($SESSION['kullanici_mail']))
{
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>IdentityOfBooks</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="index.php"><i class="fa fa-laptop"></i> Ana Sayfa </a></li>
                  ...
                  <li><a href="menu.php"><i class="fa fa-list"></i> Menüler </a></li>
                   ...
                   <li><a href="kategori.php"><i class="fa fa-archive"></i> Kategoriler </a></li>
                     <li><a href="slider.php"><i class="fa fa-image"></i>Küçük Slider </a></li>
                     <li><a href="slider.php"><i class="fa fa-image"></i>Büyük Slider </a></li>
