                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="../netting/islem.php" id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                      <?php 
                            $zaman=explode(" ",$menucek['menu_zaman']); //ayırma işlemi 
              ...
              <script type="text/javascript">
...

               {
                ...
                forcePasteAsPlainText: true
                  ...
                  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Menü URL<span >*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="form-group">
              ...
              <input type="hidden" name="menu_id" value="<?echo $menucek['menu_id'];?>">
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" name="menuekle" class="btn btn-primary">Kaydet</button>
                           </div>
                      </div>
